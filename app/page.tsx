  ...
  return (
    <main className="overflow-clip h-screen max-h-screen w-screen max-w-screen flex flex-col items-center">
      ...
      <div className="flex flex-col items-center gap-4 mt-[-8rem] w-[358px] min-w-[358px] p-4">
        <h1 className="text-base font-bold">How would you like to use Threads?</h1>
        <Link href="/sign-in">
          <div className="rounded-2xl border  pt-5 pb-5 px-6 cursor-pointer relative w-[358px] active:scale-[.98]">
        ...
        <Link href="/nonconsent">
          <div className="rounded-2xl border pt-5 pb-5 px-6 cursor-pointer relative w-[358px] active:scale-[.98]">
            <h2 className="font-bold text-[15px] pt-1 mb-2">Use without a profile </h2>

            <p className="text-[12px] text-[#777777]">
              {`You can browse Threads without a profile, but you won't`} <br /> be able to post or
      ...
      <div className="fixed text-[#777777] bottom-4 text-[12px] text-center px-4">
        <p>
          This is not an actual Threads page. It is just a web dev project and is not affiliated
          with or endorsed by Threads. It serves as a demonstration of programming abilities in a
          fullstack context.
        </p>
      </div>
    </main>
