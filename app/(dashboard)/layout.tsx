    ...
    return (
      <main className="min-w-screen min-h-screen">
        <div className="h-screen w-screen fixed top-0 left-0">
          <div className="fixed lg:top-0 bottom-0 h-[60px] lg:h-[75px] w-full flex justify-around lg:justify-center items-center lg:gap-[5rem] backdrop-blur-md">
            <Link
              href="/feed"
          ...
          <Link
            href="/feed"
            className="fixed left-[50%] translate-x-[-50%]  w-[60px] h-[60px] hover:bg-gray-800/50 flex items-center justify-center rounded-xl active:scale-[.95] lg:top-[10px] lg:left-[21rem]">
            <AtSign className="h-[38px] w-[38px]" />
          </Link>

          <div
            className={cn(
              'fixed right-[.5rem]  w-[60px] h-[60px] flex items-center justify-center rounded-xl active:scale-[.95] lg:top-[10px] lg:right-[21rem]',
